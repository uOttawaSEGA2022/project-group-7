...
class UserPOJOTest {
    ...
    void convertToClient() {
        ...
        UserPOJO user = new UserPOJO("Jane","Doe","something@mail.com","114514","114 514 Drive","Client","boring person",testCC,null,status,0, null);
    ...
    void convertToCook() {
        CreditCard testCC = new CreditCard("Jane","Doe","114 514 Drive",1145141919,114,new Date(0,1,1));
        Suspension status = new Suspension(false,new Date(0,1,1));
        Cook testCook = new Cook("Jane","Doe","something@mail.com","114514","114 514 Drive","boring person",status, 5, null);
        UserPOJO user = new UserPOJO("Jane","Doe","something@mail.com","114514","114 514 Drive","Client","boring person",testCC,null,status, 5, null);
